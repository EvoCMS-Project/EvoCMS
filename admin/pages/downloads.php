		...
		<div class="card-body">
			<form method="post">
				...
				<?php
					...
					echo '     <div class="form-group row"><span class="col-sm-2 col-form-label text-right">'. __('admin/downloads.info_title') .' :</span><div class="col-sm-10"><input name="files['.$i.'][caption]" type="text" value="'.html_encode($file->caption).'" class="form-control"></div></div>';
					echo '     <div class="form-group row"><span class="col-sm-2 col-form-label text-right">'. __('admin/downloads.info_desc') .' :</span><div class="col-sm-10"><textarea name="files['.$i.'][description]" id="textarea-'.$i.'" class="form-control" style="height: 250px;">'.html_encode($file->description).'</textarea></div></div>';
					echo '     <div class="form-group row"><span class="col-sm-2 col-form-label text-right">'. __('admin/downloads.info_fname') .' : </span><div class="col-sm-10"><input name="files['.$i.'][name]" type="text" value="'.html_encode($file->name).'" class="form-control"></div></div>';
					echo '     <div class="form-group row"><span class="col-sm-2 col-form-label text-right">'. __('admin/downloads.info_dposted') .' :</span><div class="col-sm-3"><input name="files['.$i.'][posted]" type="text" value="'.date('Y-m-d H:i', $file->posted).'" class="form-control"></div></div>';
